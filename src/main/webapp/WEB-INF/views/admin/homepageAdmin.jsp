...
<!-- iCheck -->
<link rel="stylesheet" href="${contextPath}/resources/adminLTE/plugins/iCheck/flat/blue.css">
<!-- Morris chart -->
<link rel="stylesheet" href="${contextPath}/resources/adminLTE/plugins/morris/morris.css">
<!-- jvectormap -->
...
<!-- Daterange picker -->
<link rel="stylesheet"	href="${contextPath}/resources/adminLTE/plugins/daterangepicker/daterangepicker.css">
<!-- bootstrap wysihtml5 - text editor -->
<link rel="stylesheet"	href="${contextPath}/resources/adminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
					...
					<section class="col-lg-7 connectedSortable">
						...
						<div class="box box-success">
							...
							<div class="box-body chat" id="chat-box">
								<!-- chat item -->
								<div class="item">
									<img src="${contextPath}/resources/adminLTE/dist/img/user4-128x128.jpg" alt="user image"
										class="online">
								...
								<!-- chat item -->
								<div class="item">
									<img src="${contextPath}/resources/adminLTE/dist/img/user3-128x128.jpg" alt="user image"
										class="offline">
								...
								<!-- chat item -->
								<div class="item">
									<img src="${contextPath}/resources/adminLTE/dist/img/user2-160x160.jpg" alt="user image"
										class="offline">
  ...
  $.widget.bridge('uibutton', $.ui.button);
	...
	<script src="${contextPath}/resources/adminLTE/plugins/morris/morris.min.js"></script>
	<!-- Sparkline -->
	...
	<!-- jQuery Knob Chart -->
	<script src="${contextPath}/resources/adminLTE/plugins/knob/jquery.knob.js"></script>
	<!-- daterangepicker -->
	...
	<!-- Bootstrap WYSIHTML5 -->
	<script
		src="${contextPath}/resources/adminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
	<!-- Slimscroll -->
	...
	<script src="${contextPath}/resources/adminLTE/dist/js/pages/dashboard.js"></script>
