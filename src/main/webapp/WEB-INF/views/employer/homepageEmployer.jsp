...
<meta
	...
	name="viewport">
<!-- Bootstrap 3.3.6 -->
<link rel="stylesheet" href="${contextPath}/resources/adminLTE/bootstrap/css/bootstrap.min.css">
<!-- Font Awesome -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
<!-- Ionicons -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
<!-- jvectormap -->
<link rel="stylesheet"	href="${contextPath}/resources/adminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
<!-- Theme style -->
<link rel="stylesheet" href="${contextPath}/resources/adminLTE/dist/css/AdminLTE.min.css">
<!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
<link rel="stylesheet" href="${contextPath}/resources/adminLTE/dist/css/skins/_all-skins.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img src="${contextPath}/resources/adminLTE/dist/img/user2-160x160.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${contextPath}/resources/adminLTE/dist/img/user3-128x128.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${contextPath}/resources/adminLTE/dist/img/user4-128x128.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									src="${contextPath}/resources/adminLTE/dist/img/user2-160x160.jpg" class="img-circle"
									alt="User Image">
								...
								<li class="user-footer">
									...
									<div class="pull-right">
									 ...
									 <c:if test="${pageContext.request.userPrincipal.name != null}">
								        ...
								        <%-- <h2>Welcome ${pageContext.request.userPrincipal.name} |</h2> --%> <a class="btn btn-default btn-flat" onclick="document.forms['logoutForm'].submit()">Sign out</a>
										...
										<div class="direct-chat-messages">
											...
											<div class="direct-chat-msg">
												...
												<img class="direct-chat-img"
													src="${contextPath}/resources/adminLTE/dist/img/user1-128x128.jpg" alt="message user image">
												<!-- /.direct-chat-img -->
											...
											<div class="direct-chat-msg right">
												...
												<!-- /.direct-chat-info -->
												<img class="direct-chat-img"
													src="${contextPath}/resources/adminLTE/dist/img/user3-128x128.jpg" alt="message user image">
												<!-- /.direct-chat-img -->
										...
										<div class="direct-chat-contacts">
											<ul class="contacts-list">
												<li><a href="#"> <img class="contacts-list-img"
														src="${contextPath}/resources/adminLTE/dist/img/user1-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${contextPath}/resources/adminLTE/dist/img/user7-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${contextPath}/resources/adminLTE/dist/img/user3-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${contextPath}/resources/adminLTE/dist/img/user5-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${contextPath}/resources/adminLTE/dist/img/user6-128x128.jpg" alt="User Image">
												...
												<!-- End Contact Item -->
												<li><a href="#"> <img class="contacts-list-img"
														src="${contextPath}/resources/adminLTE/dist/img/user8-128x128.jpg" alt="User Image">
								...
								<ul class="products-list product-list-in-box">
									<li class="item">
										<div class="product-img">
											<img src="${contextPath}/resources/adminLTE/dist/img/default-50x50.gif" alt="Product Image">
										</div>
	...
	<!-- Bootstrap 3.3.6 -->
	<script src="${contextPath}/resources/adminLTE/bootstrap/js/bootstrap.min.js"></script>
	<!-- FastClick -->
	<script src="${contextPath}/resources/adminLTE/plugins/fastclick/fastclick.js"></script>
	<!-- AdminLTE App -->
	<script src="${contextPath}/resources/adminLTE/dist/js/app.min.js"></script>
	<!-- Sparkline -->
	<script src="${contextPath}/resources/adminLTE/plugins/sparkline/jquery.sparkline.min.js"></script>
	<!-- jvectormap -->
	<script src="${contextPath}/resources/adminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="${contextPath}/resources/adminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<!-- SlimScroll 1.3.0 -->
	<script src="${contextPath}/resources/adminLTE/plugins/slimScroll/jquery.slimscroll.min.js"></script>
	<!-- ChartJS 1.0.1 -->
	<script src="${contextPath}/resources/adminLTE/plugins/chartjs/Chart.min.js"></script>
	<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
	<script src="${contextPath}/resources/adminLTE/dist/js/pages/dashboard2.js"></script>
	<!-- AdminLTE for demo purposes -->
	<script src="${contextPath}/resources/adminLTE/dist/js/demo.js"></script>
</body>
</html>
